...
<body class="g-sidenav-show bg-gray-100">
	...
	<div class="main-content position-relative max-height-vh-00 h-00 ">
					...
					<ul class="navbar-nav justify-content-end">
						...
						<li class="nav-item d-xl-none ps-3 pe-0 d-flex align-items-center">
							<a href="javascript:;" class="nav-link text-white p-0"> <a
								href="javascript:;" class="nav-link text-white p-0" id="iconNavbarSidenav">
					...
					<div class="card card-profile">
						...
						<div class="row justify-content-center">
							<div class="col-4 col-lg-4 order-lg-2">
								<div class="mt-n4 mt-lg-n6 mb-4 mb-lg-0">
									<a href="javascript:;"> <img src="assets/img/insta.jpg"
						...
						<div class="card-body pt-0">
							...
							<div class="text-center mt-4">
								<h5>
									<span class="font-weight-light">아이디 </span>
								</h5>
								<div class="h6 font-weight-300">
									<i class="ni location_pin mr-2"></i><%= userID %>
								</div>
								
									<h5>
									<span class="font-weight-light">이름 </span>
								</h5>
								<div class="h6 font-weight-300">
									...
									<h5>
									<span class="font-weight-light">이메일 </span>
								</h5>
								<div class="h6 font-weight-300">
									<i class="ni location_pin mr-2"></i><%= email %>
								</div>
									<i class="ni education_hat mr-2"></i> 인하공업전문대학 
								</div>
							</div>
						</div>
					</div>
